...
include_once 'Matchers/MatchInterface.php';
foreach (glob("{include/classes/PHPAuth/ZxcvbnPhp/*.php,include/classes/PHPAuth/ZxcvbnPhp/Matchers/*.php}", GLOB_BRACE) as $filename) {
